    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center py-10 w-[304px]">
        ...
        <button 
            ...
            className="p-2 px-5 mt-6 leading-6 bg-zinc-800 rounded-md border-transparent flex-1 flex justify-center items-center text-sm hover:bg-zinc-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 transition-colors disabled:opacity-50 disabled:hover:bg-brand-500">
            Dar outro feedback
        </button>
      </div>
    </>
